...
/**
 * Distance traveled since diagnostic trouble codes were cleared.
 *
 * PID: 01 31
 * Formula: Distance (km) = (A * 256) + B
 */
class DistanceSinceCCCommand : ObdCommand, SystemOfUnits {

    private var km: Int = 0

    constructor() : super("01 31")

    constructor(other: DistanceSinceCCCommand) : super(other)
    ...
    override fun getName(): String =
        AvailableCommandNames.DISTANCE_TRAVELED_AFTER_CODES_CLEARED.value
}